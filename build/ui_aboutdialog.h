...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About CheeseCoin", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>CheeseCoin</b> version", Q_NULLPTR));
...
"Copyright \302\251 2017 The CheeseCoin developers", Q_NULLPTR));
