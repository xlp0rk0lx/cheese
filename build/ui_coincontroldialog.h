...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 CHEE"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 CHEE"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 CHEE"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 CHEE"));
